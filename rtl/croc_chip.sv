...
module croc_chip import croc_pkg::*; #() (
  ...
  inout wire VSSIO
    ...
    sg13cmos5l_IOPadOut30mA   pad_vga_hsync_o  (.pad(vga_hsync_o), .c2p(vga_hsync_o));
    sg13cmos5l_IOPadOut30mA   pad_vga_vsync_o  (.pad(vga_vsync_o), .c2p(vga_vsync_o));
    sg13cmos5l_IOPadOut30mA   pad_vga0_o       (.pad(vga0_o), .c2p(vga_color_o[0]));
    sg13cmos5l_IOPadOut30mA   pad_vga1_o       (.pad(vga1_o), .c2p(vga_color_o[1]));
    sg13cmos5l_IOPadOut30mA   pad_vga2_o       (.pad(vga2_o), .c2p(vga_color_o[2]));
    sg13cmos5l_IOPadOut30mA   pad_vga3_o       (.pad(vga3_o), .c2p(vga_color_o[3]));
    sg13cmos5l_IOPadOut30mA   pad_vga4_o       (.pad(vga4_o), .c2p(vga_color_o[4]));
    sg13cmos5l_IOPadOut30mA   pad_vga5_o       (.pad(vga5_o), .c2p(vga_color_o[5]));
    sg13cmos5l_IOPadOut30mA   pad_vga6_o       (.pad(vga6_o), .c2p(vga_color_o[6]));
    sg13cmos5l_IOPadOut30mA   pad_vga7_o       (.pad(vga7_o), .c2p(vga_color_o[7]));
    sg13cmos5l_IOPadOut30mA   pad_vga8_o       (.pad(vga8_o), .c2p(vga_color_o[8]));
    sg13cmos5l_IOPadOut30mA   pad_vga9_o       (.pad(vga9_o), .c2p(vga_color_o[9]));
    sg13cmos5l_IOPadOut30mA   pad_vgaA_o       (.pad(vgaA_o), .c2p(vga_color_o[10]));
    sg13cmos5l_IOPadOut30mA   pad_vgaB_o       (.pad(vgaB_o), .c2p(vga_color_o[11]));
    sg13cmos5l_IOPadOut30mA   pad_vgaC_o       (.pad(vgaC_o), .c2p(vga_color_o[12]));
    sg13cmos5l_IOPadOut30mA   pad_vgaD_o       (.pad(vgaD_o), .c2p(vga_color_o[13]));
    sg13cmos5l_IOPadOut30mA   pad_vgaE_o       (.pad(vgaE_o), .c2p(vga_color_o[14]));
    sg13cmos5l_IOPadOut30mA   pad_vgaF_o       (.pad(vgaF_o), .c2p(vga_color_o[15]));
