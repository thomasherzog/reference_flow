...
set numPadsVertical 14
set numPadsHorizontal 18
...
set westPitch [expr {floor($westSpan / double($numPadsVertical - 1))}]
...
set southPitch [expr {floor($southSpan / double($numPadsHorizontal - 1))}]
...
set eastPitch [expr {floor($eastSpan / double($numPadsVertical - 1))}]
...
place_pad -row IO_EAST  -location [expr {$eastStart +  7*$eastPitch}] "pad_vga_hsync_o"    ; # pin no:  8
place_pad -row IO_EAST  -location [expr {$eastStart +  8*$eastPitch}] "pad_vga_vsync_o"    ; # pin no:  9
place_pad -row IO_EAST  -location [expr {$eastStart +  9*$eastPitch}] "pad_vga0_o"    ; # pin no: 10
place_pad -row IO_EAST  -location [expr {$eastStart + 10*$eastPitch}] "pad_vga1_o"    ; # pin no: 11
place_pad -row IO_EAST  -location [expr {$eastStart + 11*$eastPitch}] "pad_vga2_o"    ; # pin no: 12
place_pad -row IO_EAST  -location [expr {$eastStart + 12*$eastPitch}] "pad_vga3_o"    ; # pin no: 13
...
set northPitch [expr {floor($northSpan / double($numPadsHorizontal - 1))}]
...
place_pad -row IO_NORTH -location [expr {$northStart -  3*$northPitch}] "pad_vga4_o"       ; # pin no:  4
place_pad -row IO_NORTH -location [expr {$northStart -  4*$northPitch}] "pad_vga5_o"       ; # pin no:  5
place_pad -row IO_NORTH -location [expr {$northStart -  5*$northPitch}] "pad_vga6_o"       ; # pin no:  6
place_pad -row IO_NORTH -location [expr {$northStart -  6*$northPitch}] "pad_vga7_o"       ; # pin no:  7
place_pad -row IO_NORTH -location [expr {$northStart -  7*$northPitch}] "pad_vga8_o"       ; # pin no:  8
place_pad -row IO_NORTH -location [expr {$northStart -  8*$northPitch}] "pad_vga9_o"       ; # pin no:  9
place_pad -row IO_NORTH -location [expr {$northStart -  9*$northPitch}] "pad_vgaA_o"       ; # pin no: 10
place_pad -row IO_NORTH -location [expr {$northStart - 10*$northPitch}] "pad_vgaB_o"       ; # pin no: 11
place_pad -row IO_NORTH -location [expr {$northStart - 11*$northPitch}] "pad_vgaC_o"       ; # pin no: 12
place_pad -row IO_NORTH -location [expr {$northStart - 12*$northPitch}] "pad_vgaD_o"       ; # pin no: 13
place_pad -row IO_NORTH -location [expr {$northStart - 13*$northPitch}] "pad_vgaE_o"       ; # pin no: 14
place_pad -row IO_NORTH -location [expr {$northStart - 14*$northPitch}] "pad_vgaF_o"            ; # pin no: 15
